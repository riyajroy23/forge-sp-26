  ...
  return (
    ...
    <div className="flex flex-col min-h-screen w-full">
      <div className=" flex-1 -m-8">
        <div className="font-spacegrotesk font-bold text-lg h-17 w-full bg-gray-300 px-12 p-4 flex flex-col shrink-0 sticky top-32">
          <div className="flex flex-row gap-53">
            <div className="py-1">My Posts</div>
            ...
            <button
              ...
              className="bg-primary w-30 h-9 rounded shrink-0 flex items-center justify-center gap-3"
            >
              <BookText className="w-4 h-4 text-white shrink-0 flex items-start justify-start" />
              <p className="text-white font-spacegrotesk">Create</p>
            </button>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto bg-[var(--color-lightgrey)] p-8">
          ...
          {/* ── Post Browsing ────────────────────────────────────────────────── */}
          <section className="mb-2 px-55">
            <h1 className="headers text-3xl mb-3 text-left">My Posts</h1>
            <Card className="rounded-xl border-0 shadow-sm bg-white w-260">
...
function getMockPublicPost(): PublicPost[] {
  return [
    {
      id: 1,
      user: "Riya R",
